...
export default ({sellPrices, orderBookCallBack}) =>
{

    return sellPrices.map( (price) => 
        {
            return (
                <Grid key = { price.key} item xs >
                    ...
                    >
                        ...
                        <ul onClick = { () => orderBookCallBack(price.price) } className = 'SellOrderText' style = {{margin: 'auto', textAlign: 'center', }}>
                            { price.price } 
                        </ul>
